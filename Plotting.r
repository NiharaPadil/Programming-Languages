...
y = c(2, 4, 6, 8, 10)
# Scatter Plot
plot(x, y, type = "p", col = "blue", pch = 16, xlab = "X-axis", ylab = "Y-axis", main = "ScatterPlot Example")
# Line Plot
plot(x, y, type = "l", col = "red", lwd = 2, xlab = "X-axis", ylab = "Y-axis", main = "Line PlotExample")
# Bar Plot
barplot(y, names.arg = x, col = "green", xlab = "X-axis", ylab = "Y-axis", main = "Bar PlotExample")
# Histogram
